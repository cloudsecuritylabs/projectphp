...
class Home
{
    ...
    // bring up the userlist
		...
		// if no other controller is found, bring up the default controller.
		else
		{
			include(DOC_ROOT.'view/pageHeader.php');
